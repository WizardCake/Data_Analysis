...
@import url('https://fonts.googleapis.com/css2?family=Fira+Code:wght@300..700&family=Roboto&display=swap');
```
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendencia'),
            linewidth = 1.45) +
  labs(title = "A Crescente Tendência da Demanda Energética",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendencia'),
            linewidth = 1.45) +
  labs(title = "As Distintas Dinâmicas das Classes no Brasil",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.45) +
  labs(title = "Os Padrões Regionais no Brasil",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.45) +
  labs(title ="O Crescimento Estável Nordestino",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.45) +
  labs(title = "O Crescimento Acelerado na Região Centro-Oeste",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.45) +
  labs(title = "O Maior Centro Consumidor do País",
...
consumo %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.45) +
  labs(title = "A Estabilidade Sulista",
...
setor %>% 
  ...
  geom_line(aes(x = DataExcel,
                ...
                linetype = 'Tendência'),
            linewidth = 1.4) +
  labs(title = "O Industrial Brasileiro: Uma Visão por Segmento",
...
* Extração de Minerais Metálicos: Observa-se uma linha de tendência suavemente ascendente, esse aumento pode estar ligado à expansão da atividade de mineração em resposta à demanda por metais tanto no mercado doméstico quanto internacional. A extração de minerais metálicos é dependente de preços de commodities e demanda global. A tendência ascendente indica crescimento na atividade de mineração, possivelmente alimentada por demanda de indústrias como construção e tecnologia.
